...
def load_dataset():
    train_dataset = h5py.File('/home/kavindu/workspace/PycharmProjects/ai/cousera/data/train_catvnoncat.h5', "r")
    train_set_x_orig = np.array(train_dataset["train_set_x"][:])  # your train set features
    train_set_y_orig = np.array(train_dataset["train_set_y"][:])  # your train set labels

    test_dataset = h5py.File('/home/kavindu/workspace/PycharmProjects/ai/cousera/data/test_catvnoncat.h5', "r")
